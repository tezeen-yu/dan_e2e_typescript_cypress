...
export class GatewayServiceFormPage {
    ...
    save(): this {
        cy.locator(ServicesFormPageItems.GatewayServiceFormSubmit).click();
    ...
    fillServiceName(serviceName: string): this {
        cy.locator(ServicesFormPageItems.GatewayServiceNameInput)
            .clear()
            .type(serviceName);
        return this;
    }
    ...
    fillServiceTags(tags: string): this {
        cy.locator(ServicesFormPageItems.GatewayServiceTagsInput)
            .clear()
            .type(tags);
        return this;
    }
    ...
    fillFullURL(fullURL: string): this {
        cy.locator(ServicesFormPageItems.GatewayServiceFullURLinput)
            .clear()
            .type(fullURL);
        return this;
    }
    ...
    chooseProtocolRadioBtn(): this {
        cy.locator(ServicesFormPageItems.GatewayServiceProtocolRadioBtn).click();
        return this;
    }

    selectProtocol(protocol: string): this {
        cy.locator(ServicesFormPageItems.GatewayServiceProtocolSSelect).click();
        cy.locator(Utils.getDropdownItem(protocol)).click();
        return this;
    }

    fillHost(host: string): this {
        cy.locator(ServicesFormPageItems.GatewayServiceHostInput)
            .clear()
            .type(host);
        return this;
    }
    ...
    expandAdvancedFields(): this {
        cy.locator(ServicesFormPageItems.AdvancedFieldsExpandBtn).click();
        return this;
    }

    fillRetriesNumber(retries: number): this {
        cy.locator(ServicesFormPageItems.GatewayServiceRetriesInput)
            .clear()
